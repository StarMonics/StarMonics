...
assistant = client.beta.assistants.create(
    name="Song Composer",
    instructions="You are a music assistant capable of generating Hans Zimmer inspired songs using ABC notation. The song should evoke a sense of cosmic wonder, with low-pitch, symphonic instrumentation. Only output the ABC notation.",
...
message = client.beta.threads.messages.create(
    ...
    Output the song only in ABC notation.
